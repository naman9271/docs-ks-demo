            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-teal-600 to-green-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:from-teal-700 hover:to-green-700 transition-all duration-200 shadow-lg shadow-teal-500/25"
                >
                  Apply for IFOS →
                </motion.button>
              </div>
