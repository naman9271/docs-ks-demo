            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-rose-600 to-red-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:from-rose-700 hover:to-red-700 transition-all duration-200 shadow-lg shadow-rose-500/25"
                >
                  Become a Champion →
                </motion.button>
              </div>
