            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-purple-600 to-violet-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:from-purple-700 hover:to-violet-700 transition-all duration-200 shadow-lg shadow-purple-500/25"
                >
                  Apply for ESoC →
                </motion.button>
              </div>
